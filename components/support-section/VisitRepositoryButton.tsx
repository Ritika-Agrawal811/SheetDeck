    ...
    return (
        <a
            ...
            className={clsx(
                ...
                'before:bg-linear-0 before:from-transparent before:from-0% via-transparent via-80% before:to-purple-400 dark:before:to-purple-500 before:to-80% before:rotate-30 before:opacity-90',

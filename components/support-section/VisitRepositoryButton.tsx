    ...
    return (
        <a
            ...
            className={clsx(
                ...
                'border-2 border-purple-300 dark:border-none rounded-full',
                ...
                'cursor-pointer',
                'shadow-lg shadow-purple-300 dark:shadow-none',
                ...
                'before:bg-linear-0 before:from-transparent before:from-0% via-transparent via-80% before:to-purple-400 dark:before:to-purple-3000 before:to-80% before:rotate-30 before:opacity-90',

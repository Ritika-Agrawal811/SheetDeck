                    ...
                    <li
                        ...
                        className={clsx(
                            ...
                            view === item.view
                                ...
                                : 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-emerald-700 dark:text-emerald-600 hover:bg-purple-50 dark:hover:bg-gray-700 hover:border-transparent'
                        )}
